...
from keras.layers import (Conv2D, Input, ZeroPadding2D,
                          Add, UpSampling2D, MaxPooling2D, Concatenate, Lambda)
...
def _main(args):
    ...
    weight_decay = float(
        cfg_parser['net_0']['decay']) if 'net_0' in cfg_parser.sections() else 5e-4
    count = 0
    out_index = []
    for section in cfg_parser.sections():
        ...
        if section.startswith('convolutional'):
            ...
            print('conv2d', 'bn' if batch_normalize else '  ',
